import yaml
import navigator as nav #node_map.navigator
#from node_map.img_to_angle_dict import img_dir_to_dict
from img_to_angle_dict import img_dir_to_dict


# map nav init
#MAP_FILE = "./node_map/maps/beach.yaml"
#IMAGE_DIR = "../static/img"
MAP_FILE = "./maps/beach.yaml"
IMAGE_DIR = "../../static/img"
...
node_info = load_map_file(MAP_FILE)  # n will be a list of dicts (1 per node)
img_dict = img_dir_to_dict(IMAGE_DIR)
...
print(yaml.dump(combined_node_dicts))


with open("beach-combined.yaml", mode = "w") as file:
